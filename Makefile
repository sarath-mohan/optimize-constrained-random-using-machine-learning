...
UVM_HOME = /usr/local/apps/synopsys/vcs/etc/uvm
...
SYNOPSYS_SIM_COMMON = \
	...
	+coverage_dump=$(COVERAGE_DUMP) \
        +max_rand_sim_count=$(MAX_RAND_SIM_COUNT) \
        +ml_enabled=$(ML_ENABLED) \
        +fsm_opt_enable=$(FSM_OPT_ENABLE) \
	-ucli \
	-ucli2Proc \
...
# extra debug args
# -assert svaext \SYNOPSYS_BUILD_COMMON
# faster
